...
public class SetPatternActivity extends BasePatternActivity
    ...
    private enum LeftButtonState {
        ...
        Cancel(com.github.limboc.sample.R.string.pl_cancel, true),
        CancelDisabled(com.github.limboc.sample.R.string.pl_cancel, false),
        Redraw(com.github.limboc.sample.R.string.pl_redraw, true),
        RedrawDisabled(com.github.limboc.sample.R.string.pl_redraw, false);
    ...
    private enum RightButtonState {
        ...
        Continue(com.github.limboc.sample.R.string.pl_continue, true),
        ContinueDisabled(com.github.limboc.sample.R.string.pl_continue, false),
        Confirm(com.github.limboc.sample.R.string.pl_confirm, true),
        ConfirmDisabled(com.github.limboc.sample.R.string.pl_confirm, false);
    ...
    private enum Stage {
        ...
        Draw(com.github.limboc.sample.R.string.pl_draw_pattern, LeftButtonState.Cancel, RightButtonState.ContinueDisabled,
                true),
        DrawTooShort(com.github.limboc.sample.R.string.pl_pattern_too_short, LeftButtonState.Redraw,
                RightButtonState.ContinueDisabled, true),
        DrawValid(com.github.limboc.sample.R.string.pl_pattern_recorded, LeftButtonState.Redraw, RightButtonState.Continue,
                false),
        Confirm(com.github.limboc.sample.R.string.pl_confirm_pattern, LeftButtonState.Cancel,
                RightButtonState.ConfirmDisabled, true),
        ConfirmWrong(com.github.limboc.sample.R.string.pl_wrong_pattern, LeftButtonState.Cancel,
                RightButtonState.ConfirmDisabled, true),
        ConfirmCorrect(com.github.limboc.sample.R.string.pl_pattern_confirmed, LeftButtonState.Cancel,
    ...
    public void onPatternStart() {
        ...
        mMessageText.setText(com.github.limboc.sample.R.string.pl_recording_pattern);
