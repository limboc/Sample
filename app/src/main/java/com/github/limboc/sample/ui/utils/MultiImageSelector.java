...
import com.github.limboc.sample.ui.activity.MultiImageSelectorActivity;
...
public class MultiImageSelector {
    ...
    public void start(Activity activity){
        ...
        if(hasPermission(context)) {
            ...
            Toast.makeText(context, com.github.limboc.multi_image_selector.R.string.mis_error_no_permission, Toast.LENGTH_SHORT).show();
        }
    }
